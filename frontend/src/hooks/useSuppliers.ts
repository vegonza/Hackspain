...
import { fetchSuppliers, saveSupplier, type Supplier } from '@/api/suppliers'
...
export function useSuppliers() {
  ...
  return {
    mount, loading, failed, editing, saving, draft, editingId, search, onSearch: setSearch,
    rows: suppliers.filter(supplier => [supplier.supplier_id, supplier.legal_name, supplier.tax_id, supplier.iban, supplier.city]
