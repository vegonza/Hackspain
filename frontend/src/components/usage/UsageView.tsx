...
export function UsageView({ mount, loading, failed, stats, daily, phases, records, page, pages, setPage, labels, totalLabel, failedPending, pendingError, onRetry, retrying }: ReturnType<typeof useUsage>) {
  return <section className="usage-view" ref={mount} aria-label={labels.title} aria-busy={loading}>
    ...
    <UsageDailyChart {...{ daily, phases, loading, labels }} />
