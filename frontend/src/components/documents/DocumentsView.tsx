import { FileText, DollarSign, Building2, ShoppingCart } from 'lucide-react'
...
type Props = ReturnType<typeof useDocuments> & { usage: ReturnType<typeof useUsage>; suppliers: ReturnType<typeof useSuppliers>; orders: ReturnType<typeof useOrders> }

export function DocumentsView({ watchDocuments, labels, view, onNavigate, usage, suppliers, orders, selectedId,
