...
from pipeline.extraction_3.extraction import InvoiceExtraction, InvoiceLine, extract_invoice
...
class InvoiceExtractionTests(unittest.TestCase):
    def test_system_prompt_is_loaded_for_each_extraction_without_interpreting_invoice_braces(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                patch("pipeline.extraction_3.extractor.PROMPTS_DIRECTORY", prompts),
                patch("pipeline.extraction_3.extraction.create_extractor") as factory,
            ):
    ...
    def test_normalizes_summary_decimals_without_changing_printed_values(self) -> None:
        ...
        with patch("pipeline.extraction_3.extraction.create_extractor") as factory:
    ...
    def test_normalizes_grouping_and_preserves_signed_amounts_without_rounding(self) -> None:
        for printed, expected in [
            ...
            with self.subTest(printed=printed), patch("pipeline.extraction_3.extraction.create_extractor") as factory:
