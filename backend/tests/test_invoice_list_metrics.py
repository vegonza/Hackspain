...
from invoices.repository import InvoiceBilling, Invoice, list_invoices, write_invoice


EMPTY_BILLING = {field: None for field in InvoiceBilling.model_fields}
...
class InvoiceListMetricsTests(unittest.TestCase):
    ...
    def test_list_preserves_rpc_metrics_and_retry_state(self) -> None:
        ...
        client.rpc.return_value.execute.return_value.data = [{
            "billing": EMPTY_BILLING, "id": str(identifier), "name": "invoice.pdf", "sha256": "a" * 64,
        ...
        client.rpc.assert_called_once_with("get_invoices", {"p_offset": 0, "p_limit": 1000})
    ...
    def test_completion_times_are_returned_with_each_document_page(self) -> None:
        client, redis = MagicMock(), MagicMock()
        rows = [{
            "billing": EMPTY_BILLING, "id": str(uuid4()), "name": "invoice.pdf", "sha256": "a" * 64,
            "created_at": "2026-09-19T10:00:00+00:00", "status": "ready",
            "finished_at": "2026-09-19T10:00:20+00:00",
        } for _ in range(1001)]
        ...
        self.assertEqual([call.args for call in client.rpc.call_args_list], [
            ("get_invoices", {"p_offset": 0, "p_limit": 1000}),
            ("get_invoices", {"p_offset": 1000, "p_limit": 1000}),
        ])
        client.table.assert_not_called()
